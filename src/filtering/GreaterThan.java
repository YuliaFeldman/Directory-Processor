...
/**
 * This class represents the GreaterThan filter.
 */
public class GreaterThan extends FiltersManager{
     ...
     * @param sizeLimiter the minimum of a file's size (excluding).
     */
    public GreaterThan(boolean notOperator, double sizeLimiter) throws FiltersManagerException{
